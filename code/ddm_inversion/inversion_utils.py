...
def inversion_forward_process_new(model: PipelineWrapper,
                              x0: torch.Tensor,
    ...
    _, text_emb, uncond_emb = get_text_embeddings(prompts, [""], model)

    text_embeddings_hidden_states = text_emb.embedding_hidden_states
    text_embeddings_class_labels = text_emb.embedding_class_lables
    text_embeddings_boolean_prompt_mask = text_emb.boolean_prompt_mask

    uncond_embedding_hidden_states = uncond_emb.embedding_hidden_states
    uncond_embedding_class_lables = uncond_emb.embedding_class_lables
    uncond_boolean_prompt_mask = uncond_emb.boolean_prompt_mask
...
def inversion_reverse_process_new(model: PipelineWrapper,
                              xT: torch.Tensor,
                              skips: torch.Tensor,
                              fix_alpha: float = 0.1,
                              etas: float = 0,
